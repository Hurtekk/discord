...
module.exports = {
    ...
    execute(oldMessage, newMessage) {
        const badWords = ['chuj', 'chuja', 'chujek', 'chuju', 'chujem', 'chujnia',
            ...
            'zjebała', 'zjebala', 'zjebana', 'zjebią', 'zjebali', 'zjeby', "4r5e",
            ...
            "fuckhead", "fuckheads", "fuckin", "fucking", "fuckings", "fuckingshitmotherfucker", "fuckme",
            ...
            "gangbangs", "gaylord", "gaysex", "goatse", "God", "god-dam", "god-damned", "goddamn",
            "goddamned", "hardcoresex", "hell", "heshe", "hoar", "hoare", "hoer", "homo", "hore",
            "horniest", "horny", "hotsex", "jack-off", "jackoff", "jap", "jerk-off", "jism", "jiz",
            ...
            "shitty", "skank", "slut", "sluts", "smegma", "smut", "snatch", "son-of-a-bitch", "spunk",
        ...
        if (badWords.some((slowo) => newMessage.content.includes(slowo)) || !newMessage.author.bot) {
            // Usuń wiadomość
            newMessage.delete();
        }
